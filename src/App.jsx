...
const T = {
  en: {
    ...
    breadCalc: "Bread Calculator", byFlour: "By Flour", byTotal: "By Total Weight",
    ...
    wgFlour: "Whole grain", hydGuide: "Hydration Guide", pizzaCalcTitle: "Pizza Calculator",
    ...
    footer: "Made by S.B and Claude", activeDry: "Dry",
  ...
  fa: {
    ...
    breadCalc: "ماشین‌حساب نان", byFlour: "بر اساس آرد", byTotal: "بر اساس وزن کل",
    ...
    wgFlour: "آرد کامل", hydGuide: "راهنمای درصد آب", pizzaCalcTitle: "ماشین‌حساب پیتزا",
    ...
    starterTitle: "برنامه‌ریز استارتر", starterSub2: "محاسبهٔ وعدهٔ تغذیه",
    ...
    footer: "ساخته‌شده توسط S.B و Claude", activeDry: "خشک",
...
function QuoteCarousel() {
  const { C, lang, getFont, bp } = useApp();
    ...
    <div style={{ 
      ...
      {QUOTES.map((q, i) => {
        ...
        if (offset === 0) {
          ...
          transform = "scale(0.8) translateX(-65%) translateZ(-100px)";
          opacity = 0.85;
