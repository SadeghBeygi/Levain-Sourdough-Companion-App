...
(() => {
  ...
  if (document.getElementById("levain-fonts-v9")) return;
  const link = document.createElement("link");
  link.id = "levain-fonts-v9";
  link.rel = "stylesheet";
  link.href =
...
function updateGlobalStyles(C) {
  let s = document.getElementById("levain-boot-v9");
  if (!s) {
...
// ─── TRANSLATIONS (Fluent Farsi — bakery-authentic) ────────────────────────
const T = {
  en: {
    appName: "Levain",
    appTagline: "Sourdough Companion",
    taglineSub: "Your complete sourdough companion — from starter to scoring.",
    toolsSections: "Tools",
    doughCalc: "Dough Calculator",
    doughCalcSub: "Baker's math",
    pizzaCalc: "Pizza Calculator",
    pizzaCalcSub: "Neapolitan to wood-fired",
    recipes: "Recipes",
    recipesSub: "Eleven breads, three families",
    guide: "Process Guide",
    guideSub: "Six steps to mastery",
    trouble: "Troubleshoot",
    troubleSub: "Diagnose any problem",
    starter: "Starter Planner",
    starterSub: "Feeding ratios",
    diffOverview: "Difficulty",
    bakerPrinciple: "Baker's Principle",
    home: "Home",
    ...
    flourPerLoaf: "Flour per loaf",
    totalDoughWeight: "Total dough weight",
    leavening: "Leavening",
    sourdoughOpt: "Sourdough",
    sourdoughSub: "Wild fermentation",
    yeastOpt: "Yeast",
    yeastSub: "Predictable rise",
    ...
    yeastPizza: "Yeast",
    yeastPizzaSub: "Beginner-friendly",
    sourdoughPizza: "Sourdough",
    sourdoughPizzaSub: "Complex flavor",
    yourOven: "Your Oven",
    pizzas: "Pizzas",
    pizzaDoughWeight: "Dough per Pizza",
    toppingsBtn: "Margherita Toppings",
    freshYeastLabel: "Fresh yeast",
    orDryYeast: "or dry yeast",
    activeStarter: "Active starter",
    totalDough: "Total dough",
    homeFor: "250–290g for home",
    proFor: "260–350g for pro",
    soloMode: "Solo",
    dateNight: "Date night",
    pizzaParty: "Pizza party",
    bigGathering: "Big gathering",
    fullBakery: "Full bakery mode",
    starterTitle: "Starter Planner",
    starterSub2: "Calculate your feeding",
    howMuchStarter: "How much active starter do you need?",
    feedingRatio: "Feeding Ratio",
    seedStarter: "Seed (existing)",
    freshFlour: "Fresh flour",
    freshWater: "Fresh water",
    readyStarter: "Ready starter",
    feedingFormula: "Feeding Formula",
    ratioRef: "Ratio Reference",
    recipesTitle: "Recipes",
    recipesSub2: "Three families of bread",
    ...
    mediumHydration: "Medium Hydration",
    highHydration: "High Hydration",
    guideTitle: "Process Guide",
    guideSub2: "Master every step",
    checks: "Checklist",
    timerLabel: "Timers",
    troubleTitle: "Troubleshoot",
    troubleSub2: "Diagnose and fix",
  ...
  fa: {
    appName: "لِوِن",
    appTagline: "همراهِ خمیرترش",
    taglineSub: "راهنمای جامع نان خمیرترش — از آماده‌سازی استارتر تا خط‌زدن و پخت.",
    toolsSections: "ابزارها",
    doughCalc: "ماشین‌حساب نان",
    doughCalcSub: "درصدهای نانوایی",
    pizzaCalc: "ماشین‌حساب پیتزا",
    pizzaCalcSub: "از ناپلی تا تنور هیزمی",
    recipes: "دستورهای پخت",
    recipesSub: "یازده نان در سه دسته",
    guide: "راهنمای مراحل پخت",
    guideSub: "شش گام تا تسلط",
    trouble: "عیب‌یابی",
    troubleSub: "راه‌حل هر مشکل",
    starter: "برنامه‌ریز استارتر",
    starterSub: "نسبت‌های تغذیه",
    diffOverview: "سطح دشواری",
    bakerPrinciple: "اصل نانوا",
    home: "خانه",
    calculator: "ماشین‌حساب",
    fix: "عیب‌یابی",
    breadCalc: "ماشین‌حساب نان",
    byFlour: "بر اساس آرد",
    byTotal: "بر اساس وزن کل",
    flourPerLoaf: "آرد هر قرص",
    totalDoughWeight: "وزن کل خمیر",
    leavening: "مایهٔ تخمیر",
    sourdoughOpt: "خمیرترش",
    sourdoughSub: "تخمیر طبیعی",
    yeastOpt: "مخمر",
    yeastSub: "عملکرد قابل‌پیش‌بینی",
    yeastType: "نوع مخمر",
    freshYeast: "تازه",
    dryYeast: "خشک",
    hydration: "درصد آب",
    starterLabel: "استارتر",
    yeastLabel: "مخمر",
    salt: "نمک",
    wholeGrain: "آرد کامل",
    ofTotalFlour: "از کل آرد",
    ...
    breadFlour: "آرد نان",
    wgFlour: "آرد کامل",
    hydGuide: "راهنمای درصد آب",
    pizzaCalcTitle: "ماشین‌حساب پیتزا",
    doughType: "نوع خمیر",
    yeastPizza: "مخمر",
    yeastPizzaSub: "مناسب مبتدی‌ها",
    sourdoughPizza: "خمیرترش",
    sourdoughPizzaSub: "طعمی عمیق‌تر",
    yourOven: "فر شما",
    pizzas: "تعداد پیتزا",
    pizzaDoughWeight: "وزن هر چانه",
    toppingsBtn: "مواد پیتزا مارگاریتا",
    freshYeastLabel: "مخمر تازه",
    orDryYeast: "یا مخمر خشک",
    activeStarter: "استارتر فعال",
    totalDough: "وزن کل خمیر",
    homeFor: "۲۵۰ تا ۲۹۰ گرم برای فر خانگی",
    proFor: "۲۶۰ تا ۳۵۰ گرم برای فر حرفه‌ای",
    soloMode: "برای یک نفر",
    dateNight: "شام دو نفره",
    pizzaParty: "مهمانی پیتزا",
    bigGathering: "دورهمی بزرگ",
    fullBakery: "حالت نانوایی",
    starterTitle: "برنامه‌ریز استارتر",
    starterSub2: "محاسبهٔ وعدهٔ تغذیه",
    howMuchStarter: "چقدر استارتر فعال نیاز دارید؟",
    feedingRatio: "نسبت تغذیه",
    seedStarter: "استارتر مادر",
    freshFlour: "آرد تازه",
    freshWater: "آب تازه",
    readyStarter: "استارتر آماده",
    feedingFormula: "فرمول تغذیه",
    ratioRef: "راهنمای نسبت‌ها",
    recipesTitle: "دستورهای پخت",
    recipesSub2: "سه خانوادهٔ نان",
    allRecipes: "همهٔ دستورها",
    loaves: "تعداد قرص",
    ingredients: "مواد لازم",
    steps: "روش پخت",
    proTips: "نکات حرفه‌ای",
    lowHydration: "درصد آب پایین",
    mediumHydration: "درصد آب متوسط",
    highHydration: "درصد آب بالا",
    guideTitle: "راهنمای مراحل پخت",
    guideSub2: "تسلط بر هر مرحله",
    checks: "چک‌لیست",
    timerLabel: "زمان‌سنج‌ها",
    troubleTitle: "عیب‌یابی",
    troubleSub2: "تشخیص و راه‌حل",
    likelyCauses: "دلایل احتمالی",
    howToFix: "راه‌حل",
    ...
    copyList: "کپی کردن فهرست",
    copiedLabel: "کپی شد",
    timerStart: "شروع",
    timerPause: "توقف",
    timerDone: "پایان",
    timerRunning: "در حال شمارش",
    timerReady: "آماده",
    footer: "ساخته‌شده توسط S.B و Claude",
    activeDry: "خشک",
    ratio111: "نگهداری روزانه — ملایم، اوج در ۶ تا ۸ ساعت",
    ratio122: "تغذیهٔ استاندارد — متعادل، اوج در ۸ تا ۱۲ ساعت",
    ratio133: "متوسط — طعمی ملایم‌تر، اوج در ۱۰ تا ۱۴ ساعت",
    ratio155: "تخمیر آهسته — طعمی پیچیده، اوج در ۱۲ تا ۱۶ ساعت",
...
const RECIPES = [
  {
    ...
    name: "Classic Bagels",
    nameFa: "بیگل کلاسیک",
    sub: "Chewy, malty, boiled",
    subFa: "جویدنی، با عطر مالت، آب‌پز",
    difficulty: 3,
    diffLabel: "Medium",
    diffLabelFa: "متوسط",
    totalTime: "12–24 hrs",
    totalTimeFa: "۱۲ تا ۲۴ ساعت",
    hydration: 57,
    ingredients: [
    ...
    tipsFa: [
      "خمیر سفت = بیگل جویدنی. آب اضافه نکنید.",
      "آب‌پز کردن، همان پوستهٔ براق و معروف بیگل را ایجاد می‌کند.",
      "برای عمیق‌ترین طعم، خمیر را یک شب در یخچال تخمیر کنید.",
      "پیش از پخت با کنجد، خشخاش یا ادویهٔ ترکیبی تزیین کنید.",
    ],
  },
  {
    id: "pretzels",
    ...
    name: "Soft Pretzels",
    nameFa: "پرتزل نرم",
    sub: "Chewy, malty, lye-dipped",
    subFa: "جویدنی، مالتی، با پوستهٔ قلیایی",
    difficulty: 3,
    diffLabel: "Medium",
    diffLabelFa: "متوسط",
    totalTime: "3–4 hrs",
    totalTimeFa: "۳ تا ۴ ساعت",
    hydration: 52,
    ingredients: [
      { amount: 500, unit: "g", icon: "wheat", name: "Bread flour", nameFa: "آرد نان" },
    ...
    tipsFa: [
      "حمام جوش‌شیرین همان پوستهٔ تیرهٔ معروف را ایجاد می‌کند — هرگز از آن صرف‌نظر نکنید.",
      "برای پرتزل اصیل آلمانی از سود خوراکی استفاده کنید (حتماً دستکش بپوشید).",
      "همان روز میل کنید — خیلی زود بیات می‌شود.",
      "خردل و آبجو، همراهان سنتی پرتزل هستند.",
    ],
  },
  {
    id: "buns",
    ...
    nameFa: "نان‌های گرد نرم شام",
    sub: "Pillowy, enriched, tender",
    subFa: "پنبه‌ای، غنی‌شده، لطیف",
    difficulty: 2,
    diffLabel: "Easy",
    diffLabelFa: "آسان",
    totalTime: "3–4 hrs",
    ...
    tipsFa: [
      "شیر گرم (نه داغ) مخمر را فعال می‌کند بدون آنکه از بین ببرد.",
      "کره را کم‌کم اضافه کنید — افزودن یکباره خمیر را چرب و سست می‌کند.",
      "بلافاصله پس از خروج از فر، کرهٔ ذوب‌شده روی آن‌ها بمالید تا نرم‌تر شوند.",
      "برای برگر، ساندویچ و گوشت ریش‌ریش عالی هستند.",
    ],
  },
  {
    id: "sandwich",
    ...
    family: "medium",
    name: "Sandwich Loaf",
    nameFa: "نان تست ساندویچی",
    sub: "Soft, sliceable, everyday",
    subFa: "نرم، برش‌پذیر، روزمره",
    difficulty: 2,
    diffLabel: "Easy",
    diffLabelFa: "آسان",
    totalTime: "6–8 hrs",
    totalTimeFa: "۶ تا ۸ ساعت",
    hydration: 68,
    ingredients: [
      { amount: 500, unit: "g", icon: "wheat", name: "Bread flour", nameFa: "آرد نان" },
    ...
    tipsFa: [
      "با نان تست نرم پس از شکل‌دهی باید به‌آرامی رفتار کرد.",
      "بلافاصله پس از پخت، کره روی آن بمالید تا پوسته‌ای نرم داشته باشید.",
      "پیش از برش، اجازه دهید کاملاً خنک شود — نان داغ له می‌شود.",
      "برای تست، ساندویچ و فرنچ تست عالی است.",
    ],
  },
  {
    id: "flatbread",
    icon: "flatbread",
    family: "medium",
    name: "Sourdough Flatbread",
    nameFa: "نان تخت خمیرترش",
    sub: "The gateway bread",
    subFa: "درآمدی بر دنیای نان",
    difficulty: 1,
    diffLabel: "Very Easy",
    diffLabelFa: "بسیار آسان",
    totalTime: "8–24 hrs",
    totalTimeFa: "۸ تا ۲۴ ساعت",
    hydration: 70,
    ingredients: [
    ...
    tipsFa: [
      "با هر نوع آردی کار می‌کند — گندم، چاودار، اسپلت یا ترکیبی.",
      "هر چه تابه داغ‌تر باشد، حباب‌ها و برشتگی بهتری خواهید داشت.",
      "نان‌های پخته‌شده را داخل پارچه روی هم بچینید تا نرم بمانند.",
      "با کرهٔ سیر و سبزیجات معطر، فوراً ارتقا می‌یابد.",
    ],
  },
  {
    id: "baguette",
    ...
    nameFa: "باگت خمیرترش",
    sub: "Crisp crust, open crumb",
    subFa: "پوستهٔ ترد، بافت باز",
    difficulty: 4,
    diffLabel: "Advanced",
    diffLabelFa: "پیشرفته",
    totalTime: "18–24 hrs",
    totalTimeFa: "۱۸ تا ۲۴ ساعت",
    hydration: 72,
    ingredients: [
    ...
    tipsFa: [
      "باگت نیازمند آرد نان قوی و شکل‌دهی با اعتمادبه‌نفس است.",
      "بخار در ۱۰ دقیقهٔ اول برای تشکیل پوسته ضروری است.",
      "با زاویهٔ ۳۰ درجه و برش‌های هم‌پوشان خط بزنید تا ظاهر کلاسیک ایجاد شود.",
      "بهترین زمان مصرف تا ۶ ساعت پس از پخت است.",
    ],
  },
  {
    id: "focaccia",
    ...
    nameFa: "فوکاچیا خمیرترش",
    sub: "Dimpled, oily, glorious",
    subFa: "گودال‌دار، روغنی، باشکوه",
    difficulty: 2,
    diffLabel: "Easy",
    diffLabelFa: "آسان",
    totalTime: "12–24 hrs",
    ...
    tipsFa: [
      "در روغن زیتون صرفه‌جویی نکنید — طعم اصلی از آن می‌آید.",
      "گوجه گیلاسی، انگور یا پیاز کاراملی تزیینات فوق‌العاده‌ای می‌سازند.",
      "بهترین حالت، داغ از فر و با فرو بردن در روغن زیتون بیشتر است.",
      "تخمیر سرد شبانه برای بیشترین پیچیدگی طعم.",
    ],
  },
  {
    id: "ciabatta",
    ...
    name: "Ciabatta",
    nameFa: "چاباتا",
    sub: "Slipper bread, wild crumb",
    subFa: "نان دمپایی، بافت وحشی",
    difficulty: 4,
    diffLabel: "Advanced",
    diffLabelFa: "پیشرفته",
    totalTime: "6–8 hrs",
    ...
    tipsFa: [
      "هنگام کار با خمیر چاباتا دست‌ها را خیس کنید، نه آردی.",
      "دستکاری کم، ساختار باز بافت را حفظ می‌کند.",
      "آرد قوی (بیش از ۱۲٪ پروتئین) ضروری است.",
      "برای ساندویچ عالی، به صورت افقی برش بزنید.",
    ],
  },
  {
    id: "pizzadough",
    ...
    nameFa: "خمیر پیتزای خمیرترش",
    sub: "72-hour cold ferment",
    subFa: "تخمیر سرد ۷۲ ساعته",
    difficulty: 2,
    diffLabel: "Easy",
    diffLabelFa: "آسان",
    totalTime: "24–72 hrs",
    totalTimeFa: "۲۴ تا ۷۲ ساعت",
    hydration: 68,
    ingredients: [
    ...
    tipsFa: [
      "تخمیر سرد ۷۲ ساعته = طعم و هضم فوق‌العاده.",
      "هرگز از وردنه استفاده نکنید — حباب‌های هوا را از بین می‌برد.",
      "آرد سمولینا روی بیل پیتزا از چسبیدن جلوگیری می‌کند.",
      "در مواد پیتزا، کمتر همیشه بیشتر است.",
    ],
  },
  {
    id: "ryebread",
    ...
    family: "high",
    name: "Dark Rye Bread",
    nameFa: "نان چاودار تیره",
    sub: "Dense, hearty, complex",
    subFa: "متراکم، سیرکننده، پیچیده",
    difficulty: 3,
    diffLabel: "Medium",
    diffLabelFa: "متوسط",
    totalTime: "18–24 hrs",
    ...
    tipsFa: [
      "پنتوزان‌های چاودار ساختار را می‌سازند — ورز دادن در واقع به خمیر آسیب می‌زند.",
      "درصد آب بالا برای چاودار طبیعی است؛ چسبندگی را بپذیرید.",
      "چاودار با گذشت زمان بهتر می‌شود — نانی یک هفته‌ای از روز اول بهتر است.",
      "افزودنی‌های سنتی: زیره، تخمه آفتابگردان، گردو.",
    ],
  },
  {
    id: "artisan",
    ...
    nameFa: "بول هنری خمیرترش",
    sub: "The holy grail",
    subFa: "جام مقدس نانوا",
    difficulty: 4,
    diffLabel: "Advanced",
    diffLabelFa: "پیشرفته",
    totalTime: "24–36 hrs",
    totalTimeFa: "۲۴ تا ۳۶ ساعت",
    hydration: 78,
    ingredients: [
      { amount: 500, unit: "g", icon: "wheat", name: "Bread flour (>12%)", nameFa: "آرد نان (بیش از ۱۲٪)" },
    ...
    tipsFa: [
      "تخمیر سرد شبانه بهترین طعم و بازترین بافت را می‌دهد.",
      "با زاویهٔ ۳۰ تا ۴۵ درجه خط بزنید تا «گوش» مناسب تشکیل شود.",
      "بخار داخل قابلمهٔ دردار برای پف فر حیاتی است.",
      "هیچ دستوری را کورکورانه دنبال نکنید — خواندن خمیر را بیاموزید.",
    ],
  },
];
...
const GUIDE = [
  {
    ...
    phaseFa: "پیش از شروع",
    title: "Ready Your Starter",
    titleFa: "استارتر را آماده کنید",
    ...
    tipFa: "اگر در یخچال نگهداری شده، ۲ تا ۳ وعدهٔ تغذیهٔ پی‌درپی برای فعال‌سازی مجدد لازم است.",
    timers: [],
    timersFa: [],
  },
  {
    ...
    tipFa: "برای سرعت تخمیر ایده‌آل، از آب ۲۶ تا ۲۸ درجه استفاده کنید.",
  ...
  },
  {
    id: 3,
    icon: "timer",
    phase: "Day 1 · Morning to Afternoon",
    phaseFa: "روز ۱ — صبح تا بعدازظهر",
    ...
    tipFa: "به خمیر نگاه کنید، نه به ساعت.",
    timers: [
      { label: "Stretch & fold", minutes: 30 },
      { label: "Full bulk", minutes: 360 },
    ],
    timersFa: [
      { label: "کشش و تا", minutes: 30 },
      { label: "کل تخمیر اولیه", minutes: 360 },
    ],
  },
  {
    id: 4,
    ...
    phaseFa: "روز ۱ — بعدازظهر",
    title: "Pre-shape & Shape",
    titleFa: "پیش‌شکل و شکل‌دهی",
    ...
    tipFa: "برای ایجاد اصطکاک، روی سطحی با آرد بسیار کم کار کنید.",
  ...
  },
  {
    ...
    tipFa: "تخمیر سرد ۸ تا ۱۶ ساعته طعم بهتری می‌دهد.",
  ...
  },
  {
    ...
    tipFa: "بخار در ۲۰ دقیقهٔ اول برای پف فر حیاتی است.",
    timers: [
      { label: "Preheat", minutes: 45 },
      { label: "Steam", minutes: 20 },
      { label: "Crust", minutes: 20 },
    ],
    timersFa: [
      { label: "پیش‌گرم", minutes: 45 },
      { label: "بخار", minutes: 20 },
      { label: "پوسته", minutes: 20 },
    ],
  },
];
...
const TROUBLE = [
  {
    icon: "flat",
    problem: "Flat bread / No oven spring",
    problemFa: "نان تخت / بدون پف در فر",
  ...
  {
    icon: "flame",
    problem: "Too sour / harsh acidity",
    problemFa: "ترشی بیش‌ازحد / اسیدیتهٔ تند",
  ...
  },
  {
    ...
    problemFa: "خمیر بیش‌ازحد چسبنده",
  ...
  {
    icon: "brick",
    problem: "Crust too thick or hard",
    problemFa: "پوسته خیلی ضخیم یا سفت",
  ...
  {
    icon: "timer",
    problem: "Starter not rising",
    problemFa: "استارتر بالا نمی‌آید",
  ...
  {
    icon: "hole",
    problem: "Big holes / blowouts",
    problemFa: "حفره‌های بزرگ / ترکیدگی",
      ...
      {[1, 2, 3, 4].map((i) => (
        <span
          ...
          style={{
            ...
            boxShadow: i <= level ? `0 0 8px ${C.accent}66` : "none",
          }}
        />
      ))}
    </span>
  ...
  return (
    <div style={{ marginBottom: 28 }}>
        ...
        >
          <div
            style={{
              width: `${pct}%`,
              height: "100%",
              background: `linear-gradient(90deg, ${C.accentDeep || C.accent}, ${C.accent})`,
              borderRadius: 999,
      ...
      <div style={{ display: "flex", justifyContent: "space-between", marginTop: 10 }}>
        <span style={{ fontFamily: BODY, fontSize: 13, color: C.textFaint, fontVariantNumeric: "tabular-nums" }}>
          {num(min)}{unit}
        </span>
        <span style={{ fontFamily: BODY, fontSize: 13, color: C.textFaint, fontVariantNumeric: "tabular-nums" }}>
          {num(max)}{unit}
  ...
  return (
    <button
      ...
      style={{
        ...
        gap: 8,
        padding: "10px 20px",
        background: state === "done" ? C.success : `linear-gradient(135deg, ${C.accent}, ${C.accentDeep || C.accent})`,
        color: "#FFFFFF",
        borderRadius: 999,
        fontFamily: BODY,
        fontSize: 14,
        fontWeight: 600,
        minHeight: 44,
        boxShadow: state === "done" ? `0 4px 14px ${C.success}44` : `0 4px 14px ${C.accent}44`,
...
function PageFooter() {
  ...
  return (
    <div style={{ textAlign: "center", padding: "48px 0 24px", marginTop: 24 }}>
      ...
      <div style={{ fontFamily: BODY, fontSize: 14, color: C.textFaint, letterSpacing: "-0.005em" }}>
        {t("footer")}
      </div>
    </div>
  );
  ...
  return (
    <GlassPanel
      ...
      style={{
        ...
        padding: "14px 16px",
        marginBottom: 10,
        border: `1px solid ${done ? C.success : C.glassBorder}`,
      }}
    >
      <div
        style={{ position: "relative", width: 72, height: 72, flexShrink: 0, margin: stack ? "0 auto" : 0 }}
        aria-hidden="true"
      >
        ...
        {!done && (
          <button
            ...
            style={{
              padding: "10px 20px",
              borderRadius: 999,
              background: running ? C.accentSoft : `linear-gradient(135deg, ${C.accent}, ${C.accentDeep || C.accent})`,
              ...
              minWidth: 84,
              minHeight: 44,
              boxShadow: running ? "none" : `0 4px 12px ${C.accent}44`,
            }}
          >
        ...
        return (
          <button
            ...
            style={{
              ...
              padding: "12px 10px",
              borderRadius: 14,
              background: active ? `linear-gradient(135deg, ${C.accent}, ${C.accentDeep || C.accent})` : "transparent",
              ...
              alignItems: "center",
              gap: 3,
              boxShadow: active ? `0 4px 12px ${C.accent}33` : "none",
            }}
          >
            ...
            {opt.sub && (
              <div style={{ fontSize: 13, fontWeight: 400, opacity: active ? 0.9 : 0.75 }}>{opt.sub}</div>
            )}
          </button>
        );
      })}
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 12, minWidth: 0, flex: 1 }}>
        ...
        <div style={{ minWidth: 0 }}>
          ...
          {sub && (
            <div style={{ fontFamily: BODY, fontSize: 13, color: C.textFaint, marginTop: 2 }}>{sub}</div>
          )}
        </div>
      </div>
      <span
...
function HomeTab({ setTab }) {
  ...
  const diffRows =
    lang === "fa"
      ? [
          { icon: "flatbread", name: "نان تخت", desc: "با هر آردی. ۳ دقیقه.", level: 1 },
          { icon: "loaf", name: "نان قالبی", desc: "نیاز به فر. ۵ دقیقه.", level: 2 },
          { icon: "rye", name: "چاودار", desc: "صبر می‌طلبد.", level: 3 },
          { icon: "artisan", name: "نان هنری", desc: "اوج مهارت نانوا.", level: 4 },
        ]
      : [
  ...
  const bakerQuote =
    lang === "fa"
      ? "هیچ دستوری را نمی‌توان کورکورانه دنبال کرد. هر نانوا باید با ابزار و محیط آشپزخانهٔ خود هماهنگ شود."
      ...
      >
        {cards.map((card, i) => (
          <GlassPanel
            ...
            style={{
              padding: bp.mobile ? "24px 20px" : "28px 24px",
              animation: `fadeUp 0.6s cubic-bezier(0.2, 0.8, 0.2, 1) ${i * 0.05}s backwards`,
            }}
          >
            <div
              style={{
                width: isWideLayout ? 56 : 48,
                height: isWideLayout ? 56 : 48,
                borderRadius: isWideLayout ? 16 : 14,
                background: C.accentSoft,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
...
function BreadCalc() {
  ...
  useEffect(() => {
    setYeastPct(YEAST_DEFAULTS[yeastType]);
  }, [yeastType]);
    ...
    <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8, marginTop: 12 }}>
            {[
              ...
              >
                ...
                <span style={{ fontSize: 13, opacity: 0.8 }}>{t(lKey)}</span>
              </button>
            ))}
          </div>
        )}
      ...
      <GlassPanel style={{ padding: "26px 22px 16px", marginBottom: 24 }}>
        ...
        >
          ...
          <span style={{ fontFamily: BODY, fontSize: 14, color: C.textSub, letterSpacing: "-0.005em" }}>
            {hLevel.desc}
          </span>
        </div>
        {leavenType === "sourdough" ? (
          ...
          <Slider
            ...
            min={YEAST_RANGES[yeastType][0]}
            max={YEAST_RANGES[yeastType][1]}
            step={0.05}
          />
        )}
      ...
      >
        ...
        <ResultRow
          ...
          label={
            leavenType === "sourdough"
              ? t("starterLabel")
              : `${yeastType === "fresh" ? t("freshYeast") : t("dryYeast")} ${t("yeastLabel")}`
          }
          sub={`${num(leavenPct)}%`}
          value={dough.leaven}
        />
...
// ─── PIZZA CALCULATOR (Bread-style layout: inputs left, results right) ─────
function PizzaCalc() {
  const { C, t, lang, num, bp } = useApp();
  ...
  const controlsPanel = (
    <div>
      ...
      {/* Combined: Pizzas + Dough Weight + Hydration */}
      <GlassPanel style={{ padding: "24px", marginBottom: 24 }}>
        ...
        >
          ...
          <button
            onClick={() => setPizzaCount(Math.min(20, pizzaCount + 1))}
            aria-label={t("increase")}
            type="button"
            style={{
              background: "transparent",
    ...
    <div style={{ position: isDesktop ? "sticky" : "static", top: 100 }}>
      ...
      >
        ...
        >
          ...
          >
            {num(pizzaCount)} {lang === "fa" ? "پیتزا" : "pizza"}
            {pizzaCount > 1 && lang !== "fa" ? "s" : ""} · {num(fmt(pizza.totalDough))}g
          </span>
          <CopyButton getText={getShoppingList} />
        </div>
        ...
        {doughType === "yeast" ? (
          <>
            <ResultRow
              icon="sparkles"
              label={`${yeastType === "fresh" ? t("freshYeast") : t("dryYeast")} ${t("yeastLabel")}`}
              value={yeastType === "fresh" ? pizza.freshYeastAmt : pizza.dryYeastAmt}
            />
            <div
              style={{
                padding: "6px 0 12px",
            ...
            >
              <span style={{ fontFamily: BODY, fontSize: 13, color: C.textFaint }}>
                {yeastType === "fresh"
                  ? `${t("dryYeast")}: ${num(fmt2(pizza.dryYeastAmt))}g`
                  : `${t("freshYeastLabel")}: ${num(fmt2(pizza.freshYeastAmt))}g`}
              </span>
            </div>
          </>
        ) : (
          ...
          >
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <span style={{ fontFamily: BODY, fontSize: 15, color: C.text, fontWeight: 500 }}>
                  {lang === "fa" ? "ریحان" : "Basil leaves"}
                </span>
              </div>
              <span
                style={{
              ...
              >
                ...
                <span style={{ fontSize: 13, color: C.textFaint, marginLeft: 6, fontFamily: BODY }}>
                  (≈ {num(pizza.basilPots)} {lang === "fa" ? "گلدان" : "pot"}
                  {pizza.basilPots > 1 && lang !== "fa" ? "s" : ""})
                </span>
              </span>
            </div>
          </div>
  ...
  // Oven and tips below, full width
  const ovenSection = (
          ...
          return (
            <GlassPanel
              ...
              style={{
                ...
                background: active ? `linear-gradient(135deg, ${C.accentSoft}, ${C.glass})` : C.glass,
            ...
            >
              <div
                style={{
                  ...
                  background: active ? `linear-gradient(135deg, ${C.accent}, ${C.accentDeep || C.accent})` : C.accentSoft,
                  color: active ? "#FFFFFF" : C.accent,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  transition: "all 0.3s",
                  boxShadow: active ? `0 4px 16px ${C.accent}44` : "none",
                }}
              >
        ...
        >
          <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                {lang === "fa" ? oven.nameFa : oven.nameEn}
              </div>
              <div
                style={{
                  fontFamily: BODY,
...
function StarterCalc() {
  ...
  const starterCalc = useMemo(() => {
    ...
    return {
      seed: (targetStarter * r.seed) / parts,
      flour: (targetStarter * r.flour) / parts,
      water: (targetStarter * r.water) / parts,
    };
              ...
              {FEED_RATIOS.map((r, i) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 14,
                    background:
                      feedRatio === i ? `linear-gradient(135deg, ${C.accent}, ${C.accentDeep || C.accent})` : "transparent",
                    ...
                    fontVariantNumeric: "tabular-nums",
                    minHeight: 48,
                    boxShadow: feedRatio === i ? `0 4px 12px ${C.accent}33` : "none",
                  }}
                >
                  {r.label}
                </button>
          ...
          {modes.map((m) => (
            <button
              ...
              style={{
                ...
                fontSize: 14,
                fontWeight: 600,
                background: mode === m.value ? `linear-gradient(135deg, ${C.accent}, ${C.accentDeep || C.accent})` : "transparent",
                ...
                justifyContent: "center",
                gap: 6,
                boxShadow: mode === m.value ? `0 4px 12px ${C.accent}33` : "none",
              }}
            >
...
function RecipesTab() {
  ...
  if (selected) {
    ...
    return (
      <div
        style={{ padding: bp.mobile ? "0 24px 32px" : bp.tablet ? "0 40px 40px" : "0 48px 48px" }}
        className="fade-up"
      >
        <button
          onClick={() => {
        ...
        >
          <div
            style={{
              ...
              background: `linear-gradient(135deg, ${C.accentSoft}, ${C.accentDim})`,
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              color: C.accent,
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <button
              onClick={() => setLoaves(Math.max(1, loaves - 1))}
              aria-label={t("decrease")}
              type="button"
              style={{
                width: 44,
    ...
    <div style={{ marginBottom: isDesktop ? 48 : 36 }}>
      ...
      >
        ...
        <div>
          ...
          <div style={{ fontFamily: BODY, fontSize: 14, color: C.textFaint, marginTop: 2 }}>
            {family === "low" ? "50–60%" : family === "medium" ? "65–72%" : "78–85%"} · {num(recipes.length)}{" "}
            {t("recipesCount")}
          </div>
        </div>
      </div>
...
function GuideTab() {
              ...
              >
                ...
                {timers.length > 0 && (
                  <div style={{ marginTop: 22 }}>
                    ...
                    {timers.map((timer) => (
                      <StepTimer key={timer.label} label={timer.label} minutes={timer.minutes} />
                    ))}
                  </div>
                )}
                <div
  ...
  const bakersPanel = (
    <GlassPanel style={{ padding: "26px 24px", position: isDesktop ? "sticky" : "static", top: 100 }}>
      ...
      <p style={{ fontFamily: BODY, fontSize: 15, color: C.textSub, marginBottom: 20, lineHeight: 1.6 }}>
        {t("bakersMathBody")}
      </p>
      {bakersRows.map(([n, f, ex], i) => (
        ...
        >
          <span style={{ fontFamily: DISPLAY, fontSize: 17, color: C.text, fontWeight: 600, letterSpacing: "-0.01em" }}>
            {n}
          </span>
          <span
            style={{ fontFamily: BODY, fontSize: 14, color: C.accent, fontVariantNumeric: "tabular-nums", fontWeight: 500 }}
          >
            {f}
          </span>
          <span
        ...
        >
          {glossary.map(([term, def], i) => (
            <div
              ...
              style={{
                borderTop:
                  i > 0 && !isDesktop ? `1px solid ${C.divider}` : isDesktop && i >= 2 ? `1px solid ${C.divider}` : "none",
...
export default function App() {
  ...
  const renderContent = () => {
    switch (tab) {
      case "home":
        return <HomeTab setTab={setTabProxy} />;
      case "calc":
        return <CalcTab initialMode="bread" />;
      case "pizza":
        return <CalcTab initialMode="pizza" />;
      case "recipes":
        return <RecipesTab />;
      case "guide":
        return <GuideTab />;
  ...
  // Increased max widths for desktop
